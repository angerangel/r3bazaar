...
emit-header: func [t f] [emit form-header/gen t f %make-headers ] ;It appends to output an header (t is tile, f is file) with the optioanl string "Atomatic generated by %make-headers" 
